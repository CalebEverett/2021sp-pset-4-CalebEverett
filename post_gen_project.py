...
INIT_REPO = "yes" == "yes"
CREATE_SECRETS = "yes" == "yes"
MERGE_REMOTE = "yes" == "yes"
ACCESS_TOKEN = os.getenv("ACCESS_TOKEN")

BASE_URL = "https://api.github.com"
REPO_NAME = "csci-e-29/2021sp-pset-4-CalebEverett"
        ...
        with open(DOTENV_PATH, "r") as ef:
            ...
            with open(".github/workflows/build.yml", "r+") as bf:
                ...
                for ei, el in enumerate(env_lines):
                    name, value = el.split("=")
                    create_secret(name, value.replace("\n", ""), key_id, key)
...
if MERGE_REMOTE:
    repo.create_remote("origin", url="git@github.com:csci-e-29/2021sp-pset-4-CalebEverett.git")
